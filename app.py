...
from routes import  teacher, test_stars, student, parallel, admins, courses, user, subject, access
...
# ---------------- Nuevo acceso para estudiantes -----------------------
@app.route('/new-access', methods=[ "GET"])
def new_access():
    return render_template("layouts/accesoNuevo.html")

# ---------------- Retorna la lista de los estudiantes ingresados -----------------------
@app.route('/list-students', methods=[ "GET"])
def list_students():
    return render_template("layouts/lista.html")

@app.route('/get-students', methods=[ "POST", "GET"])
def get_students():
    return access.get_students(mongo)

# ---------------- Retorna las nuevas aula ingresadas -----------------------
@app.route('/get-aulas', methods=[ "GET"])
def get_aulas():
    return access.get_aulas(mongo)
